...
#  How to read the entire file as a list page 209
...
print('-' * 60)
print(start + "How to read the entire file as a list\n" + end)
...
print(sp1 + 'members = file.readlines()')
print(sp1 + 'print(members[0], end=" ")')
print(sp1 + 'print(members[1])')
