...
print(sp6 + 'r' + sp1 + 'Read' + sp4 + "If the fiie doesn't exist, this mode causes a file not found error.")
print(sp6 + 'w' + sp7 + 'Write' + sp7 + "If the fiie doesn't exist, this mode creates it. If the file already")
print(sp3 + 'exists, this module erases all existing data.')
print(sp6 + 'a' + sp7 + 'Append' + sp2 + "If the fiie doesn't exist, this mode creates it. If the file already")
