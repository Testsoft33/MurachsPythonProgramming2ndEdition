...
# How to handle a ValueError exception,Page 235
...
print('-' * 60)
print(start + "How to handle a ValueError" + end)
...
print(sp1 + 'except ValueError:')
print(sp3 + 'print("You entered an invalid integer. Please try again."')
print(sp1 + 'print("Thanks!")')

print(start + '\nThe console for a valid integer' + end)
print('-' * 60)
print('Enter an integer: 5')
print('You entered a valid integer of 5.')
print('Thanks!')

print('\n' + start + 'The console for an invalid integer' + end)
print('-' * 60)
print('Enter an integer: five')
